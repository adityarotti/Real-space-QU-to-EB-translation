...
\caption{This figure depicts the same as the bottom panel of \fig{fig:equ-bqu-spectra_rad_cutoff}. The Stokes Q and U maps corresponding to E and B modes used in this analysis are constructed using the following relations: $\equ=\fqu-\fqu_{Local}^B$, $\bqu=\fqu-\fqu_{Local}^{E}$.}
