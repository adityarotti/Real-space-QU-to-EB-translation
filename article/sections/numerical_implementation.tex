...
In this section we present the results of evaluating the local convolution given in \eq{eq:op_qu2equbqu}, to decompose the total Stokes Q and U parameters into those correspond to the E modes and B modes of polarization respectively. We reiterate that this procedure only relies on real space operation on the total Stokes Q and U maps and do not go through the process of constructing the E and B modes as is usually the case.
%
\begin{figure}[!t] 
\centering
