...
Altering $\ell_{\rm max}$ would necessitate updating $\beta_o$, hence we avoid doing that. In order to ensure that we are changing only one parameter, we focus on high pass filtering, which we achieve by altering $\ell_{\rm min}$. 
%
\begin{figure}[!t]
\centering
\subfigure[]{\includegraphics[width=1.\columnwidth]{simulated/multipole_filter/f_rad_ker_fn_vary_lmin.pdf}}\\
\subfigure[]{\includegraphics[width=0.48\columnwidth]{simulated/multipole_filter/fp2_rad_ker_fn_vary_lmin.pdf}}
\subfigure[]{\includegraphics[width=0.48\columnwidth]{simulated/multipole_filter/fm2_rad_ker_fn_vary_lmin.pdf}}
\caption{}
\label{}
\end{figure}
%
...
\begin{figure}[!t]
\centering
\subfigure[]{\includegraphics[width=0.49\columnwidth]{simulated/multipole_filter/eqmask/ee-spectrum-rteb-2beta_multipole_filtering.pdf}}
\subfigure[]{\includegraphics[width=0.49\columnwidth]{simulated/multipole_filter/eqmask/bb-spectrum-rteb-2beta_multipole_filtering.pdf}}
\subfigure[]{\includegraphics[width=0.49\columnwidth]{simulated/multipole_filter/eqmask/ee-spectrum-requ-2beta_multipole_filtering.pdf}}
\subfigure[]{\includegraphics[width=0.49\columnwidth]{simulated/multipole_filter/eqmask/bb-spectrum-rbqu-2beta_multipole_filtering.pdf}}
\caption{}
\label{}
\end{figure}
%
