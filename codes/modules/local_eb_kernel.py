...
#	Convolution kernels.
	...
	def convert_qu2eb(self,tqu,discsize=180.,nest=False):
	...
	def decompose_qu2_equ_bqu(self,tqu,discsize=180.,nest=False):
	...
	def convert_qu2eb_box(self,tqu,discsize=180.,nest=False):
	...
	def convert_qu2eb_thetasqinv(self,tqu,discsize=180.,nest=False):
	...
	def convert_eb2qu_box(self,teb,discsize=180.,nest=False):
