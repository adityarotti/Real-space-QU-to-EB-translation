...
\eeq
%
\revisit{It is also interesting to note that the radiation kernel ($\mm_{G}$) and the convolution kernel ($\mm_{B}$) become progressively identical as one approaches the equator, which is a consequence of $\gamma \simeq -\alpha$ in the vicinity of the equator. This result can also be understood as the flat sky case where the radiation and convolution kernels are expected to be identical.}
