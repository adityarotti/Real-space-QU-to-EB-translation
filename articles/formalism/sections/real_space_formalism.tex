...
\beq \label{eq:sum_spin_shf}
 \sum_{m}{{}_{s_1}}Y^*_{\ell m}(\hat{n}_i){{}_{s_2}}Y_{\ell m}(\hat{n}_j) = \sqrt{\frac{2\ell+1}{4 \pi}} {{}_{s_2}}Y_{\ell \,-s_1}(\beta,\alpha) e^{- i s_2 \gamma} \,,
\eeq
%
