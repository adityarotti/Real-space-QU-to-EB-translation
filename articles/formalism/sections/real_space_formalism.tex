...
\eeqrys
%
The explicit form of the real space operator $\bar O$ can be derived by contracting over all the matrix operators.\footnote{While this manuscript was in preparation, work appeared in \cite{2018JCAP...05..059L} that implements the similar idea of real-space transformation of Stokes $Q/U$ parameters to their $E/B$ counterparts, but we treat it here in much more detail.}
