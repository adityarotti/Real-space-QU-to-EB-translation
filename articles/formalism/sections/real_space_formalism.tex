...
\rfedit{The azimuthal operations do not depend on the choice of basis functions, and could have been been argued to have the form $e^{-i2 \alpha}$ by requiring to construct a spin-0 field given some spin-2 fields. The radial part of the kernel however is determined by the choice of the basis functions. Motivated by this observation, we can think of constructing convolution kernels with different radial dependences, hence allowing control over the non-locality of the convolution kernels.} \comment{This is generally true for all the local kernels. So shift this line to the section where we explore different radial functions.}
%--------------------------------------------------------
%--------------------------------------------------------
