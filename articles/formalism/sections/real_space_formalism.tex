...
\beqry
    ...
    {}_{+2}X(\hat{n}_q) &= \Bigg\lbrace \mathcal{M}^*_{G} \star [E+iB] \Bigg\rbrace(\hat{n}_q) \hspace{0.8cm} &\textrm{\emph {Convolution kernel}}\,, \label{eq:eb2qu_convolution_explicit}
\eeqry
%
