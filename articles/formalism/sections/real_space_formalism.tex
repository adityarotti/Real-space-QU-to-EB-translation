...
&=& - \left( \left[ \sum_{\ell=\ell_{\rm min}}^{\ell_{\rm max}} \sqrt{\frac{2 \ell+1}{4 \pi}}Y^*_{\ell 2} \right]  \circ {}_{+2}X \right) = - \Bigg\lbrace \mathcal{M}^* \circ {}_{+2}X \Bigg\rbrace(\hat{n}_0)\,, \label{eq:qu2eb_convolution} 
\eeqry
\end{subequations}
%
...
{}_{+2}X(\hat{n}_0) &=& - \left( \left[ \sum_{\ell=\ell_{\rm min}}^{\ell_{\rm max}} \sqrt{\frac{2 \ell+1}{4 \pi}}Y_{\ell 2} \right]  \circ [E+iB] \right)= - \Bigg\lbrace \mathcal{M} \circ [E + iB] \Bigg\rbrace(\hat{n}_0)\,, 
\eeqry
\end{subequations}
%
