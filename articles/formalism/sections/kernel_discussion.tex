...
\beq
\beta_0= {\rm min}\left(180,180 \frac{22}{\ell_{\rm max}} \right)
\eeq
provides a reasonable estimate of this transition point for  ${}_{\mm}f$. \revisit{This empirical function also provides a reasonable estimate for the transition point for the function ${}_{\md}f$ particularly for high $\ell_{\rm max}$ and it systematically over-predicts the transition point for the function ${}_{\mi}f$ as seen in \fig{fig:rad_ker_decay}.}
