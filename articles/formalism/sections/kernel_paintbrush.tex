...
The $B$ part of the Green's function, traced along the filament, cancels itself except at the filament ends.  This results in a non-zero $B$ pattern for the filament.  For a North--South filament, the $B$-mode pattern is positive on the North-East and South-West, and negative in the North-West and South-East.  \revisit{The non-zero $B$ result is somewhat surprising given that the polarization pattern is invariant under parity.}
