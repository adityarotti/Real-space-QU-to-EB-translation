...
\begin{figure}
  ...
  \caption{
    ...
    In all images, the longitude angle increases to the left (East in sky convention).\comment{Colorbar on plots to give a sense of B amplitude as compared to E.}}
