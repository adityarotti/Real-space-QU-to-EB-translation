...
\eeq
%
\revisit{where $\bar{\eth}^2_{\textrm BL}$ denotes the band limited spin lowering operator, thats relevant in the case of a discretely sampled spin-2 field on the sphere. In the limit of $\ell_{\rm max} \rightarrow \infty$, the $\bar{\eth}^2_{\textrm BL} \rightarrow \bar{\eth}^2$.}
